        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="../admin/Staff.php">
              ...
              <i class="fa fa-user mr-2" aria-hidden="true"></i>Staff Registration
            </a>
		      </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/Courses.php">
              ...
              <i class="fa fa-book mr-2" aria-hidden="true"></i>Department
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/staff-salary.php">
              <span data-feather="layers"></span>
              <i class="fa fa-money mr-2" aria-hidden="true"></i> Staff Salary
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/staff-attendance.php">
              <span data-feather="layers"></span>
