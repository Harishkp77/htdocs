	...
	<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
		<div class="sub-main">
			...
			<div>
				<div>
					<!-- Search Teacher Form -->
					<form action="staff.php" method="POST" class="form-inline mt-3">

						<div class="form-group">
							<label for="searchCriteria">Search By:</label>
							<select class="form-control mx-2" id="searchCriteria" name="search_criteria">
								<option value="id">Staff ID</option>
								<option value="first_name">Staff First Name</option>
							</select>
						</div>

						<input type="text" class="form-control mb-2 mr-sm-2" id="search_input" name="search_input" placeholder="Enter ID or First Name" required>


						<button type="submit" class="btn btn-primary mb-2" name="search_teacher" style="border: 1px solid #007bff;">Search</button>
