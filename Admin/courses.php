				...
				<div class="row">
					<div class="col-md-12">
						<form action="courses.php" method="post">
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="course_code" class="form-control" required placeholder="Enter Department Code">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputPassword1">Department Name:</label>
										<input type="text" name="course_name" class="form-control" required placeholder="Enter Department Name">
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row w-100">
								<div class="col-md-12">
									<input type="submit" name="sub" value="Add Department" class=" btn btn-primary ml-auto">
								</div>
							</div>
						</form>
					</div>
