...
if ($_SESSION["LoginAdmin"] && !$_SESSION['LoginStaff']) {
	$teacher_id = $_GET['teacher_id'];
} else if (!$_SESSION["LoginAdmin"] && $_SESSION['LoginStaff']) {
	$teacher_email = $_SESSION['LoginStaff'];
	$teacher_id = "";
} else { ?>
	<script>
				...
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h5>Staff I'd:</h5> <?php echo $row['teacher_id']  ?><br><br>
						</div>
					</div>
				</div>
				<hr>
