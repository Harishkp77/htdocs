...
<?php 
	...
	$teacher_id=$_SESSION['LoginStaff'];
	...
	if (isset($_POST['sub'])) {
		...
		if ($run) {  ?>
 		...
 		<?php }
 			...
 			<script type="text/javascript">
 				alert("Staff data has not been updated paid due to some errors");
 			</script>
 		<?php }
	}
?>
...
<html lang="en">
	...
	<body>
		...
		<?php include('../common/staff-sidebar.php') ?>  
			...
			<div class="sub-main">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
						<form action="staff-personal-information.php" method="post">
							<?php $teacher_id=$_SESSION['LoginStaff'];
